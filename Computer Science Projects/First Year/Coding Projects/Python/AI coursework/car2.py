...
info_gains = []
for feature in X_train.columns:  #Exclude target column
...
#Decision tree display and accuracy calculation
print("\nDecision Tree Accuracy:", accuracy_score(y_test, y_pred))
plt.figure(figsize=(15,10))
tree.plot_tree(clf, feature_names=X.columns, class_names=["unacc", "acc", "good", "vgood"], filled=True)
plt.show()
